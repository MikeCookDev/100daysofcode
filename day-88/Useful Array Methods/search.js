...
while (true) {
	search = prompt ("Search for a product in out store. Type 'list' to show all of the produce and 'quit'to exit");
...
/*Use the array method that combines all of the items in an array into a single string. 
In the final string, the array items should be separated by a comma AND a space. 
Finally, log the final string value to the console.
